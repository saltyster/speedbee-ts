 ...
 */
#ifdef WINCE
	#include "config/eci_config_wince.h"
#else
	#if defined(WIN32)
		#include "config/eci_config_x86_win32.h"
	#elif defined(_WRS_KERNEL)
		#include "config/eci_config_zynx_arm_vxworks.h"
	#elif defined(__APPLE__)
		#define X86_64_OSX
	#else
		#include "config/eci_config_x86_64_linux.h"
	#endif
#endif
